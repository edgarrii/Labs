...
int chooseMenu() {
	...
	while (true) {
		...
		if (choose_menu == 0) { setColor(2, 0); cout << " - Fill matrix" << endl; setColor(15, 0); }
		else { cout << " Fill matrix" << endl; }

		if (choose_menu == 1) { setColor(2, 0); cout << " - Swap between MAX and MIN elements" << endl; setColor(15, 0); }
		else { cout << " Swap between MAX and MIN elements" << endl; }

		if (choose_menu == 2) { setColor(2, 0); cout << " - Change the lines in pairs" << endl; setColor(15, 0); }
		else { cout << " Change the lines in pairs" << endl; }

		if (choose_menu == 3) { setColor(2, 0); cout << " - Show matrix" << endl; setColor(15, 0); }
		else { cout << " Show matrix" << endl; }

		if (choose_menu == 5) { setColor(2, 0); cout << " - End the program" << endl; setColor(15, 0); }
...
int chooseFillArr() {
	...
	while (true) {
		...
		if (choose_menu == 0) { setColor(2, 0); cout << " - Through the random" << endl; setColor(16, 0); }
		else { cout << " Through the random" << endl; }

		if (choose_menu == 1) { setColor(2, 0); cout << " - Through the keyboard" << endl; setColor(16, 0); }
